...
namespace Connection.models
{
    ...
    public interface ITenantsessionRepo : IGenericRepo<TenantSession>
    {
    ...
    public class clsSessionRepo : GenericRepo<TenantSession>, ITenantsessionRepo
    {
        ...
        public async Task<TenantSession?> GetByToken(string HashedToken)
        {
            try
            {
                return await _context.TenantsSessions.IgnoreQueryFilters()
                                  .AsNoTracking().
